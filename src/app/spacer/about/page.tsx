    ...
    return (
        <div className="flex flex-col gap-32">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 border border-white/10">
                <div className="p-16 bg-black flex flex-col gap-8">
                    <span className="text-[10px] uppercase tracking-[0.5em] text-[#00f3ff] font-bold">The Problem</span>
                ...
                <div className="p-16 bg-black flex flex-col gap-8">
                    <span className="text-[10px] uppercase tracking-[0.5em] text-[#00f3ff] font-bold">The Solution</span>
                    <p className="text-sm opacity-60 leading-relaxed font-light">
            ...
            <section className="py-24 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="h-px w-24 bg-[#00f3ff]/40" />
                    ...
                    <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#00f3ff]">Bharath — Architect & Educator</span>
                </div>
            </section>
        </div>
    );
